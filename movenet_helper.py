...
# REFACTOR GOOGLE'S SHITTY CODE WHEN I HAVE THE TIME!!!
...
# This is dumb af... Come on google...
# KEYPOINT_DICT = {
#     'nose': 0,
#     'left_eye': 1,
#     'right_eye': 2,
...
def draw_prediction_on_image(
    ...
    output_image_height=None, show_keypoint_names:bool=False
):
    ...
    Args:
        ...
        show_keypoint_names: A bool which determines whether we show the keypoint name
        as text in the output image.
    ...
    if keypoint_locs.shape[0]:
        ...
        if show_keypoint_names:
            for i,p in enumerate(keypoint_locs):
                ax.text(p[0], p[1], KEYPOINT_NAMES[i], size=8)
...
def determine_crop_region(
  ...
  for i,joint in enumerate(KEYPOINT_NAMES):
    target_keypoints[joint] = [
      keypoints[0, 0, i, 0] * image_height,
      keypoints[0, 0, i, 1] * image_width
    ]
